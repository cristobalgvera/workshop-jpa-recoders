...
public class MainControlador {
    ...
    public String terminarViaje(@RequestParam("chofer-id") Long choferId,
                                @RequestParam("pasajero-id") Long pasajeroId,
                                Model model) {
        Viaje viaje = viajeServicio.findById(new ViajeId(choferId, pasajeroId));
